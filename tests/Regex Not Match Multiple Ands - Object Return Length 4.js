const mockData = {
  ...
  "or_table_one":[{"entry":"hobby","method":"doesNotMatchRegExIgnoreCase","comparator":"(swim).*?"}],
  "or_table_two":[{"entry":"university","method":"doesNotMatchRegExIgnoreCase","comparator":"(man).*?"}],
  "or_table_three":[{"entry":"name","method":"doesNotMatchRegExIgnoreCase","comparator":"(mar).*?"}],
  "returnIfTrue":"true",
  "arrayTarget":[
...
assertThat(variableResult).hasLength(3);